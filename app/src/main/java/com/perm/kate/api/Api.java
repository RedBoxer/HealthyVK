...
public class Api {
    ...
    public ArrayList<User> getProfiles(Collection<Long> uids, String domain, String fields, String name_case, String captcha_key, String captcha_sid) throws IOException, JSONException, KException{
